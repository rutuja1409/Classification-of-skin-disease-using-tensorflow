"""
Mask R-CNN
Train on the Acne and Skintag dataset.
------------------------------------------------------------
...
# Number of classes (including background)
    NUM_CLASSES = 1 + 2  # Background + acne + skintag
...
class skinDataset(utils.Dataset):
    ...
    def load_skin(self, dataset_dir, subset):
        ...
        self.add_class("skin", 2, "skintag")
        
        
        self.class_name_to_ids = {'acne':1,'skintag':2}
...
def train(model):
    ...
    dataset_train.load_skin(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = skinDataset()
    dataset_val.load_skin(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect skin.')
